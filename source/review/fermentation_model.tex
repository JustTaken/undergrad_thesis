\startsection[title={Modelo fermentativo}]
	...
	A forma basica das equações diferenciais para compostos solúveis, no modelo, são dadas pela \in{Equação}[eq:soluble_differential]. Isto é, a \in{Equação}[eq:soluble_differential] engloba a fora das equações diferenciais de materiais como varelato, butirato, nitrogênio e ácidos graxos, alem dos produtos usuais (hidrogênio, methano, dióxido de carbono) e os ions da solução.
