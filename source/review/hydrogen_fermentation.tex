\startsection[title={Fermentação de hidrogênio}]
	...
	A \in{Equação}[eq:shift] solidifica o conceito nomeado translação água-gás, ou {\emph water-gas shift}, que se encaixa no contexto da movimentação do oxigênio da água para o monóxido de carbono, oxidando o carbono, reduzindo o hidrogenio, e formando gás hidrogênio.
