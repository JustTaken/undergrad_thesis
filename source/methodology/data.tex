...
\startsection[title={Simulação}]
	...
	O modelo adotado corresponde à variante proposta por \cite[authoryears][ref::rosen_0], incluindo as aproximações por equações diferenciais algébricas para o cálculo do \chemical{pH} e da concentração de \chemical{H_2} descritas nesse trabalho.
\stopsection
